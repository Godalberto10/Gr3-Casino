#include "include/JuegoPalillos.hpp"


int JuegoPalillos :: pedirNumero(int min, int max) {
	do {
...
void JuegoPalillos :: escribeJuego(int numPalillos) {
...
int JuegoPalillos :: juegaOrdenador(int numPalillos) {
	num = (numPalillos - 1) % 4;
	if (num == 0) {
...
int JuegoPalillos :: juegaUsuario(int numPalillos) {
...
void JuegoPalillos::jugar(Usuario u) {
	jugarOtraVez = 1;
